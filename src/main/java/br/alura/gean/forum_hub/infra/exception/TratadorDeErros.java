package br.alura.gean.forum_hub.infra.exception;
...
import br.alura.gean.forum_hub.service.validations.ValidacaoException;
...
public class TratadorDeErros {
  ...
  public ResponseEntity<String> tratarErroRegraDoNegocio(ValidacaoException ex) {
